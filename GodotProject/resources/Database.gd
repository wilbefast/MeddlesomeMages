...
var _thesaurus = {
	...
	"epithet_domination" : ["The Beast", "The Undefeated", "Master Of Magic", "Lords' Bane" ],
	"epithet_immortality" : [ "Everlasting", "The Undying", "Ageless", "The Unblemished" ],
	"epithet_knowledge" : ["Hawkeye", "The Wise", "All-Seeing", "The Scholar" ],
	"epithet_justice" : ["The Just", "Stormcloud", "Arbitor Of Ages", "Judge Of Kings" ],
	"epithet_freedom" : ["The Wandering", "Thousand Jests", "The Unbound", "Kingless" ],
	"legend" : ["speaking in hushed tones", "scaring their children with tales", "spreading word far and wide"],
	"colour_domination" : ["blood-red", "purple", "black", "shadowy" ],
	"colour_immortality" : [ "white", "grey", "silvery", "shimmering" ],
	"colour_knowledge" : [ "blue", "indigo", "teal", "aquamarine" ],
	"colour_justice" : [ "ardent", "orange", "red", "fiery" ],
	"colour_freedom" : [ "green", "brown", "yellow", "earthen" ],
	"clothes" : [ "robes", "hood", "cloak", "mask", "hat", "boots", "mantel" ],
